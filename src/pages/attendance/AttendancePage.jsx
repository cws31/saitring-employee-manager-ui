...
export default function AttendancePage() {
  ...
  /*
   * Extract validation errors returned by GlobalExceptionHandler.
   *
   * Example:
   *
   * {
  ...
  const handleSaveAttendance = async (e) => {
    ...
    try {
      ...
      setSuccess(
        `Attendance updated for ${employee.name} (Day ${day})`
      );
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            Click any cell to manage status and add optional notes/reasons.
          </p>
        ...
        <div className="flex items-center space-x-3 bg-white px-3 py-1.5 rounded shadow-sm border border-gray-100">
          ...
          <button
            ...
            className="px-2.5 py-1 bg-gray-50 hover:bg-gray-100 text-gray-600 rounded text-xs transition-colors cursor-pointer"
          >
            &larr;
          </button>

          <span className="text-sm font-medium text-gray-800 min-w-[130px] text-center">
            {monthName}
          </span>
        ...
        <table className="min-w-max divide-y divide-gray-100 text-xs">
          ...
          <thead className="bg-gray-50/50">
            ...
            <tr>
              ...
              <th className="sticky left-0 bg-gray-50/90 px-4 py-3 text-left font-medium text-gray-500 uppercase tracking-wider z-10 border-r border-gray-100">
                Employee
              </th>
              ...
              {daysArray.map((day) => (
                <th
                  key={day}
                  className="px-2 py-3 text-center font-normal text-gray-400 w-9 border-r border-gray-100"
                >
                  {day}
                </th>
              ))}
                ...
                >
                  ...
                  {daysArray.map((day) => {
                    ...
                    return (
                      <td
                        key={day}
                        className="px-1 py-2 text-center border-r border-gray-100 relative"
                      >
                        ...
                        >
                          ...
                          {reason && (
                            <span
                              className="absolute -top-1 -right-1 w-2 h-2 bg-blue-600 rounded-full ring-1 ring-white"
                              title="Has reason note"
                            />
                          )}
      ...
      <div className="mt-4 flex flex-wrap items-center gap-4 text-xs text-gray-600 bg-white p-3 rounded-lg shadow-sm border border-gray-100">
        ...
        <div className="flex items-center space-x-1.5">
          <span className="w-3 h-3 bg-emerald-100 border border-emerald-200 rounded inline-block" />
          <span>
        ...
        <div className="flex items-center space-x-1.5">
          <span className="w-3 h-3 bg-rose-100 border border-rose-200 rounded inline-block" />
          <span>
            ...
            >
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <label
                    className={`flex items-center justify-center p-2 rounded border cursor-pointer text-xs font-normal transition ${
                      modalData.status ===
                      'PRESENT'
