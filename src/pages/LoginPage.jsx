    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full bg-white p-8 rounded-lg shadow-sm border border-gray-100">
        ...
        <div className="text-center mb-6">
          ...
          <h1 className="text-lg font-medium text-blue-900 tracking-wide">
            Sonu Saitring
          </h1>
        ...
        {/* Backend Error */}
        {error && (
          <div className="bg-red-50 text-red-600 p-3 rounded text-xs mb-4 border border-red-100">
        ...
        {step === 1 ? (
          ...
          >
            ...
            <div>
              ...
              <label className="block text-xs font-normal text-gray-600 mb-1 text-center">
                Enter 6-digit OTP
              </label>
