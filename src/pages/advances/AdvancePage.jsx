...
export default function AdvancePage() {
  ...
  /*
   * Extract the backend exception message.
   *
  ...
  /*
   * Convert backend field errors into our frontend field error state.
   */
  ...
  const loadData = async () => {
    ...
    try {
      ...
      const advRes =
        await AdvanceService.getMonthlyAdvances(
          year,
          month
        );
  ...
  const handleInlineSubmit = async (empId) => {
    ...
    try {
      ...
      if (inputData.editingId) {
        ...
        await AdvanceService.updateAdvance(
          inputData.editingId,
          payload
        );
        ...
        await AdvanceService.recordAdvance(
          payload
        );
      ...
      if (
        Object.keys(backendFieldErrors)
          .length > 0
      ) {
        setFieldErrors(
          backendFieldErrors
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <div>
          ...
          <h1 className="text-xl font-medium text-gray-800 tracking-wide">
            Advance Payments / Hisab
          </h1>

          <p className="text-xs text-gray-500 mt-0.5">
            Track mid-month cash or online advances given to employees.
          </p>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
        ...
        <h2 className="text-sm font-medium text-gray-800 mb-4 tracking-wide">
          Employee Advances & History ({monthName})
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {employees.map((emp) => {
            ...
            return (
              <div
                key={emp.id}
                className="border border-gray-100 rounded-lg p-4 bg-gray-50/50 flex flex-col justify-between shadow-sm"
              >
                ...
                <div>
                  ...
                  <div className="flex justify-between items-center border-b border-gray-100 pb-2.5 mb-3">
                    ...
                    <span
                      className={`text-xs font-medium ${totalSummaryColor}`}
                    >
                      Total:{' '}
                      {formatCurrency(
                        summary.totalAmount
                      ...
                      {summary.transactions.map(
                        (tx) => {
                          ...
                          return (
                            <div
                              key={tx.id}
                              className={`p-2 rounded border text-xs flex justify-between items-center shadow-sm ${badgeColorClass}`}
                            >
                    ...
                    <div className="bg-white p-3 rounded border border-blue-100 space-y-2 text-xs shadow-sm">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full border rounded p-1.5 text-xs focus:outline-none transition-colors ${
                            fieldErrors.amount
